...
public:
	...
	FLowEntryHttpRequestExecutionAction* Execution = nullptr;
	UPROPERTY()
	FDelegateULowEntryHttpRequestOnComplete ExecutionEvent;
	UPROPERTY()
	UObject* ExecutionEventObject = nullptr;
	UPROPERTY()
	ULowEntryHttpRequestResponse* ExecutionResponse = nullptr;
	...
	*/
	...
	/**
	* Returns the percentage of how much data has been sent so far (from 0.0 to 1.0).
	* 
	* Sometimes this does not return the correct value, this is caused by internal engine code.
	* Don't rely on this function to always return the correct value.
	*/
	...
	double GetSentPercentage();

	/**
	* Returns the percentage of how much data has been received so far (from 0.0 to 1.0).
	* 
	* Sometimes this does not return the correct value, this is caused by internal engine code.
	* Don't rely on this function to always return the correct value.
	*/
