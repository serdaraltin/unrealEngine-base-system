...
UNREALROOTPATH = /home/main/Programs/unreal-engine
GAMEPROJECTFILE =/home/main/Unreal_Projects/Base_System/Base_System.uproject
...
TARGETS = \
	...
	UnrealServer \
	Base_System-Linux-Debug  \
	Base_System-Linux-DebugGame  \
	Base_System-Linux-Test  \
	Base_System-Linux-Shipping  \
	Base_System \
	Base_SystemEditor-Linux-Debug  \
	Base_SystemEditor-Linux-DebugGame  \
	Base_SystemEditor-Linux-Test  \
	Base_SystemEditor-Linux-Shipping  \
	Base_SystemEditor\
	configure
...
Base_System-Linux-Debug:
	 $(PROJECTBUILD) Base_System Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_System-Linux-DebugGame:
	 $(PROJECTBUILD) Base_System Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_System-Linux-Test:
	 $(PROJECTBUILD) Base_System Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_System-Linux-Shipping:
	 $(PROJECTBUILD) Base_System Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_System:
	 $(PROJECTBUILD) Base_System Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_SystemEditor-Linux-Debug:
	 $(PROJECTBUILD) Base_SystemEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_SystemEditor-Linux-DebugGame:
	 $(PROJECTBUILD) Base_SystemEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_SystemEditor-Linux-Test:
	 $(PROJECTBUILD) Base_SystemEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_SystemEditor-Linux-Shipping:
	 $(PROJECTBUILD) Base_SystemEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Base_SystemEditor:
	 $(PROJECTBUILD) Base_SystemEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
